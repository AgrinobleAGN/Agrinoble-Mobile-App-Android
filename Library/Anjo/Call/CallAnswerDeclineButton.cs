...
{ 
    public class CallAnswerDeclineButton : LinearLayout, View.IOnTouchListener
	{
		...
		public virtual void StartRingingAnimation()
		{
            try
            {
                if (!Animating)
		...
		public virtual void StopRingingAnimation()
		{
            try
            {
                if (Animating)
		...
		public virtual void SetAnswerDeclineListener(IAnswerDeclineListener listener)
		{
			Listener = listener;
		}
