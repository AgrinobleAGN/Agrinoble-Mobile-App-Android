...
namespace WoWonder.Activities.Story.Adapters
{
                    ...
                    { 
                        ...
                        if (type == "Video")
                        {
                            ...
                            else
                            {
                                ...
                                holder.StoryVideoView.SetVideoPath(file?.Path);
                                holder.StoryVideoView.Start();
                            }
                        }
                        else  
    ...
    public class StoryShowAdapterViewHolder : RecyclerView.ViewHolder, View.IOnClickListener, View.IOnLongClickListener, MediaPlayer.IOnCompletionListener, MediaPlayer.IOnPreparedListener
    {
