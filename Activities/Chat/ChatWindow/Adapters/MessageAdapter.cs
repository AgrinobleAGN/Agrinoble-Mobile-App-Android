    ...
    public class MessageAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
        ...
        private void AutoLinkTextViewOnAutoLinkOnClick(object sender1, AutoLinkOnClickEventArgs autoLinkOnClickEventArgs)
        {
            try
            {
                ...
                {
                    case "Email":
                        Methods.App.SendEmail(MainActivity, autoLinkOnClickEventArgs.P1.Replace(" ", ""));
                        break;
                    case "Website":
                        {
                    ...
                    case "Mention":
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    intent.PutExtra("Key", autoLinkOnClickEventArgs.P1.Replace("@", "").Replace(" ", "").Replace("\n", ""));
                                    MainActivity.StartActivity(intent);
                                }
                            }
                    ...
                    case "Number":
                        Methods.App.SaveContacts(MainActivity, autoLinkOnClickEventArgs.P1.Replace(" ", "").Replace("\n", ""), "", "2");
                        break;
                }
            }
            catch (Exception e)
        ...
        private async void LoadMapOfChatItem(Holders.ImageViewHolder holder, int position, MessageData message, bool update)
        {
            try
            {
                if (holder.UserName != null && ShowName)
        ...
        private void LoadImageOfChatItem(Holders.ImageViewHolder holder, int position, MessageData message, bool update)
        {
            try
            {
                if (holder.UserName != null && ShowName)
