    ...
    public class AgoraVideoCallActivity : AppCompatActivity, ISensorEventListener
    {
            ...
            try
            {
                ...
                switch (CallType)
                {
                    ...
                    case "Agora_video_calling_start":
                        ...
                        {
                            string channelName = "room" + Methods.Time.CurrentTimeMillis();
                            int uid = 0;
                            ...
                            Token = token.BuildTokenWithUid(ListUtils.SettingsSiteList?.AgoraChatAppId, ListUtils.SettingsSiteList?.AgoraAppCertificate, channelName, uid, RtcTokenBuilder.Role.RolePublisher, timestamp);
                        }
        ...
        private void InitializeAgoraEngine()
        {
            try
            {
                ...
                AgoraEngine = RtcEngine.Create(this, "9471c47b589c4a35abf3f7338ef18629", AgoraHandler);
