...
public class NearbyShopsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.NearbyShops.Adapters.NearbyShopsAdapter, WoWonder", NearbyShopsAdapter.class, __md_methods);
	}


	public NearbyShopsAdapter ()
	{
		super ();
		if (getClass () == NearbyShopsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.NearbyShops.Adapters.NearbyShopsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public NearbyShopsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == NearbyShopsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.NearbyShops.Adapters.NearbyShopsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
