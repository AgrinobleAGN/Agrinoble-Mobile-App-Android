...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Events.Adapters.EventAdapter, WoWonder", EventAdapter.class, __md_methods);
	}
	...
	public EventAdapter ()
	{
		...
		if (getClass () == EventAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Events.Adapters.EventAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}
	...
	public EventAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == EventAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Events.Adapters.EventAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
