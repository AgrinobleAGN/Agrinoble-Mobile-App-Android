...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Movies.Adapters.MoviesAdapter, WoWonder", MoviesAdapter.class, __md_methods);
	}
	...
	public MoviesAdapter ()
	{
		...
		if (getClass () == MoviesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Movies.Adapters.MoviesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}
	...
	public MoviesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MoviesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Movies.Adapters.MoviesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
