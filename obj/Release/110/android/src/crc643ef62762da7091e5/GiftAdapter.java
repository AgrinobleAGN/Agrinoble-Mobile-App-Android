...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Gift.Adapters.GiftAdapter, WoWonder", GiftAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == GiftAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Gift.Adapters.GiftAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public GiftAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == GiftAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Gift.Adapters.GiftAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
