...
public class NearbyBusinessAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.NearbyBusiness.Adapters.NearbyBusinessAdapter, WoWonder", NearbyBusinessAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == NearbyBusinessAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.NearbyBusiness.Adapters.NearbyBusinessAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public NearbyBusinessAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == NearbyBusinessAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.NearbyBusiness.Adapters.NearbyBusinessAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
