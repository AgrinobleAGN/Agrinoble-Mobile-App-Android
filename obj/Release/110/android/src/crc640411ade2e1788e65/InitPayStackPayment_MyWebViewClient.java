...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Payment.InitPayStackPayment+MyWebViewClient, WoWonder", InitPayStackPayment_MyWebViewClient.class, __md_methods);
	}
	...
	public InitPayStackPayment_MyWebViewClient ()
	{
		...
		if (getClass () == InitPayStackPayment_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("WoWonder.Payment.InitPayStackPayment+MyWebViewClient, WoWonder", "", this, new java.lang.Object[] {  });
	}
