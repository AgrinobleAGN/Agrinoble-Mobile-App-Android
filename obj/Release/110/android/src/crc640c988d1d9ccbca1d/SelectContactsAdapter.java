...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Contacts.Adapters.SelectContactsAdapter, WoWonder", SelectContactsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SelectContactsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Contacts.Adapters.SelectContactsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public SelectContactsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == SelectContactsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Contacts.Adapters.SelectContactsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
