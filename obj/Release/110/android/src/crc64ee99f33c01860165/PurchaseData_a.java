...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("InAppBilling.Lib.PurchaseData+a, InAppBilling", PurchaseData_a.class, __md_methods);
	}


	public PurchaseData_a ()
	{
		super ();
		if (getClass () == PurchaseData_a.class)
			mono.android.TypeManager.Activate ("InAppBilling.Lib.PurchaseData+a, InAppBilling", "", this, new java.lang.Object[] {  });
	}
