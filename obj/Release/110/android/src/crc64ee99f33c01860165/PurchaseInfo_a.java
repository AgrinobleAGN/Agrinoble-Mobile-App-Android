...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("InAppBilling.Lib.PurchaseInfo+a, InAppBilling", PurchaseInfo_a.class, __md_methods);
	}


	public PurchaseInfo_a ()
	{
		super ();
		if (getClass () == PurchaseInfo_a.class)
			mono.android.TypeManager.Activate ("InAppBilling.Lib.PurchaseInfo+a, InAppBilling", "", this, new java.lang.Object[] {  });
	}
