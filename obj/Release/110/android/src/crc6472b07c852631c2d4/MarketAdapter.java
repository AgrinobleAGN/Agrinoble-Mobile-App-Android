...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Market.Adapters.MarketAdapter, WoWonder", MarketAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MarketAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Market.Adapters.MarketAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public MarketAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MarketAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Market.Adapters.MarketAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
