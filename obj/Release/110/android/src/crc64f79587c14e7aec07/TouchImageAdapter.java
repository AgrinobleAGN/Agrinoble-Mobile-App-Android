package crc64f79587c14e7aec07;


public class TouchImageAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.UsersPages.Adapters.TouchImageAdapter, WoWonder", TouchImageAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == TouchImageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UsersPages.Adapters.TouchImageAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}
