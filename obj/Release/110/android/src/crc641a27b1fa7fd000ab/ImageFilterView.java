...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.NiceArt.ImageFilterView, WoWonder", ImageFilterView.class, __md_methods);
	}


	public ImageFilterView (android.content.Context p0)
	{
		super (p0);
		if (getClass () == ImageFilterView.class)
			mono.android.TypeManager.Activate ("WoWonder.NiceArt.ImageFilterView, WoWonder", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}


	public ImageFilterView (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == ImageFilterView.class)
			mono.android.TypeManager.Activate ("WoWonder.NiceArt.ImageFilterView, WoWonder", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
