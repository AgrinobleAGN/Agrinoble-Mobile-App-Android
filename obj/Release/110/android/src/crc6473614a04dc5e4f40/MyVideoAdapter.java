...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.MyVideo.Adapters.MyVideoAdapter, WoWonder", MyVideoAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MyVideoAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.MyVideo.Adapters.MyVideoAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public MyVideoAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MyVideoAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.MyVideo.Adapters.MyVideoAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
