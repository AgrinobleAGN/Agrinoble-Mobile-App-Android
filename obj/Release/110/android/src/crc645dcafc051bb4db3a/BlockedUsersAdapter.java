...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.BlockedUsers.Adapter.BlockedUsersAdapter, WoWonder", BlockedUsersAdapter.class, __md_methods);
	}
	...
	public BlockedUsersAdapter ()
	{
		...
		if (getClass () == BlockedUsersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.BlockedUsers.Adapter.BlockedUsersAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}
	...
	public BlockedUsersAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == BlockedUsersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.BlockedUsers.Adapter.BlockedUsersAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
