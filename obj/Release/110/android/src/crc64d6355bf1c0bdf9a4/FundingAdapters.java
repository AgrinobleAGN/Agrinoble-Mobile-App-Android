...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Fundings.Adapters.FundingAdapters, WoWonder", FundingAdapters.class, __md_methods);
	}


	public FundingAdapters ()
	{
		super ();
		if (getClass () == FundingAdapters.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Fundings.Adapters.FundingAdapters, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public FundingAdapters (android.app.Activity p0)
	{
		super ();
		if (getClass () == FundingAdapters.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Fundings.Adapters.FundingAdapters, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
