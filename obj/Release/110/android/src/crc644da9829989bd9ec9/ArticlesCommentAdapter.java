...
public class ArticlesCommentAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Articles.Adapters.ArticlesCommentAdapter, WoWonder", ArticlesCommentAdapter.class, __md_methods);
	}


	public ArticlesCommentAdapter ()
	{
		super ();
		if (getClass () == ArticlesCommentAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Articles.Adapters.ArticlesCommentAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ArticlesCommentAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == ArticlesCommentAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Articles.Adapters.ArticlesCommentAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
