...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.UserProfile.Adapters.UserGroupsAdapter, WoWonder", UserGroupsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == UserGroupsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.UserGroupsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public UserGroupsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == UserGroupsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.UserGroupsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
