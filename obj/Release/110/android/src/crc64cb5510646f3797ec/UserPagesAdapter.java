...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.UserProfile.Adapters.UserPagesAdapter, WoWonder", UserPagesAdapter.class, __md_methods);
	}


	public UserPagesAdapter ()
	{
		super ();
		if (getClass () == UserPagesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.UserPagesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public UserPagesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == UserPagesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.UserPagesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
