...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.UserProfile.Adapters.MyPagesAdapter, WoWonder", MyPagesAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MyPagesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.MyPagesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public MyPagesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MyPagesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.MyPagesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
