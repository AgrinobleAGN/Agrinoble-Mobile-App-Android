...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Adapters.GendersAdapter, WoWonder", GendersAdapter.class, __md_methods);
	}


	public GendersAdapter ()
	{
		super ();
		if (getClass () == GendersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Adapters.GendersAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public GendersAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == GendersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Adapters.GendersAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
