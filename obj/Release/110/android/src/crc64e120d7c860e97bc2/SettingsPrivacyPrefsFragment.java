package crc64e120d7c860e97bc2;


public class SettingsPrivacyPrefsFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_onPreferenceTreeClick:(Landroidx/preference/Preference;)Z:GetOnPreferenceTreeClick_Landroidx_preference_Preference_Handler\n" +
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.SettingsPreferences.Privacy.SettingsPrivacyPrefsFragment, WoWonder", SettingsPrivacyPrefsFragment.class, __md_methods);
	}


	public SettingsPrivacyPrefsFragment ()
	{
		super ();
		if (getClass () == SettingsPrivacyPrefsFragment.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.SettingsPreferences.Privacy.SettingsPrivacyPrefsFragment, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public SettingsPrivacyPrefsFragment (android.app.Activity p0)
	{
		super ();
		if (getClass () == SettingsPrivacyPrefsFragment.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.SettingsPreferences.Privacy.SettingsPrivacyPrefsFragment, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
