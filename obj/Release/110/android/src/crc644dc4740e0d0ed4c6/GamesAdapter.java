...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Games.Adapters.GamesAdapter, WoWonder", GamesAdapter.class, __md_methods);
	}
	...
	public GamesAdapter ()
	{
		...
		if (getClass () == GamesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.Adapters.GamesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public GamesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == GamesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.Adapters.GamesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
