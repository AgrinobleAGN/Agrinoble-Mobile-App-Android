...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.AddPost.Adapters.FeelingsAdapter, WoWonder", FeelingsAdapter.class, __md_methods);
	}


	public FeelingsAdapter ()
	{
		super ();
		if (getClass () == FeelingsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.AddPost.Adapters.FeelingsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public FeelingsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == FeelingsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.AddPost.Adapters.FeelingsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
