...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.AddPost.Adapters.AddPollAdapter, WoWonder", AddPollAdapter.class, __md_methods);
	}


	public AddPollAdapter ()
	{
		super ();
		if (getClass () == AddPollAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.AddPost.Adapters.AddPollAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public AddPollAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == AddPollAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.AddPost.Adapters.AddPollAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
