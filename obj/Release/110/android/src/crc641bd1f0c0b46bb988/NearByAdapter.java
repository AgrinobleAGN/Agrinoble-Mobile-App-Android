...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.NearBy.Adapters.NearByAdapter, WoWonder", NearByAdapter.class, __md_methods);
	}
	...
	public NearByAdapter ()
	{
		...
		if (getClass () == NearByAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.NearBy.Adapters.NearByAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public NearByAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == NearByAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.NearBy.Adapters.NearByAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
