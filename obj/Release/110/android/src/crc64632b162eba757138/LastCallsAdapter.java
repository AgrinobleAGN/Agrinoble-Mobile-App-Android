...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.MsgTabbes.Adapter.LastCallsAdapter, WoWonder", LastCallsAdapter.class, __md_methods);
	}


	public LastCallsAdapter ()
	{
		super ();
		if (getClass () == LastCallsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.MsgTabbes.Adapter.LastCallsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public LastCallsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LastCallsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.MsgTabbes.Adapter.LastCallsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
