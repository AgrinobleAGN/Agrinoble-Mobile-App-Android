...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Live.Adapters.LiveMessageAdapter, WoWonder", LiveMessageAdapter.class, __md_methods);
	}
	...
	public LiveMessageAdapter ()
	{
		...
		if (getClass () == LiveMessageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Live.Adapters.LiveMessageAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}
	...
	public LiveMessageAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LiveMessageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Live.Adapters.LiveMessageAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
