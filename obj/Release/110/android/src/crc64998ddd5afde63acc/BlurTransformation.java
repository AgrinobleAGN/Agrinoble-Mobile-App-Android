...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Helpers.CacheLoaders.BlurTransformation, WoWonder", BlurTransformation.class, __md_methods);
	}
	...
	public BlurTransformation ()
	{
		...
		if (getClass () == BlurTransformation.class)
			mono.android.TypeManager.Activate ("WoWonder.Helpers.CacheLoaders.BlurTransformation, WoWonder", "", this, new java.lang.Object[] {  });
	}
	...
	public BlurTransformation (android.content.Context p0)
	{
		super ();
		if (getClass () == BlurTransformation.class)
			mono.android.TypeManager.Activate ("WoWonder.Helpers.CacheLoaders.BlurTransformation, WoWonder", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
