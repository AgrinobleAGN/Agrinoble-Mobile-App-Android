...
public class TouchMyPhotoAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.MyPhoto.Adapters.TouchMyPhotoAdapter, WoWonder", TouchMyPhotoAdapter.class, __md_methods);
	}


	public TouchMyPhotoAdapter ()
	{
		super ();
		if (getClass () == TouchMyPhotoAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.MyPhoto.Adapters.TouchMyPhotoAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}
