...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Offers.Adapters.OffersAdapter, WoWonder", OffersAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == OffersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Offers.Adapters.OffersAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public OffersAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == OffersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Offers.Adapters.OffersAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
