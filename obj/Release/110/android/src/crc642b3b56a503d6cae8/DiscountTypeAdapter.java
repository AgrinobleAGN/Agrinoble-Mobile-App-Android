...
public class DiscountTypeAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Offers.Adapters.DiscountTypeAdapter, WoWonder", DiscountTypeAdapter.class, __md_methods);
	}


	public DiscountTypeAdapter ()
	{
		super ();
		if (getClass () == DiscountTypeAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Offers.Adapters.DiscountTypeAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public DiscountTypeAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == DiscountTypeAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Offers.Adapters.DiscountTypeAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
