...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.ChatWindow.ChatWindowActivity, WoWonder", ChatWindowActivity.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ChatWindowActivity.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.ChatWindow.ChatWindowActivity, WoWonder", "", this, new java.lang.Object[] {  });
	}


	public ChatWindowActivity (int p0)
	{
		super (p0);
		if (getClass () == ChatWindowActivity.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.ChatWindow.ChatWindowActivity, WoWonder", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
	}
