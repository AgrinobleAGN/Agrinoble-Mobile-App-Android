...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Articles.CreateBlogActivity+MyWebViewClient, WoWonder", CreateBlogActivity_MyWebViewClient.class, __md_methods);
	}
	...
	public CreateBlogActivity_MyWebViewClient ()
	{
		...
		if (getClass () == CreateBlogActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Articles.CreateBlogActivity+MyWebViewClient, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public CreateBlogActivity_MyWebViewClient (crc6447b7d00dc8d7ead2.CreateBlogActivity p0)
	{
		super ();
		if (getClass () == CreateBlogActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Articles.CreateBlogActivity+MyWebViewClient, WoWonder", "WoWonder.Activities.Articles.CreateBlogActivity, WoWonder", this, new java.lang.Object[] { p0 });
	}
