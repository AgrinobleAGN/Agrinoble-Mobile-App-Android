...
public class ShowApplyJobsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Jobs.Adapters.ShowApplyJobsAdapter, WoWonder", ShowApplyJobsAdapter.class, __md_methods);
	}


	public ShowApplyJobsAdapter ()
	{
		super ();
		if (getClass () == ShowApplyJobsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Jobs.Adapters.ShowApplyJobsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ShowApplyJobsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ShowApplyJobsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Jobs.Adapters.ShowApplyJobsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
