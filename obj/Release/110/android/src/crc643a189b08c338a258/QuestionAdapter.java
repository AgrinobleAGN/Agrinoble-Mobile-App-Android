...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Jobs.Adapters.QuestionAdapter, WoWonder", QuestionAdapter.class, __md_methods);
	}
	...
	public QuestionAdapter ()
	{
		...
		if (getClass () == QuestionAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Jobs.Adapters.QuestionAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public QuestionAdapter (crc649ec0a7aa76ef071c.CreateJobActivity p0)
	{
		super ();
		if (getClass () == QuestionAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Jobs.Adapters.QuestionAdapter, WoWonder", "WoWonder.Activities.Jobs.CreateJobActivity, WoWonder", this, new java.lang.Object[] { p0 });
	}
