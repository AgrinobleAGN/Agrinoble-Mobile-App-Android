...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Search.Adapters.SearchPageAdapter, WoWonder", SearchPageAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SearchPageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Search.Adapters.SearchPageAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public SearchPageAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == SearchPageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Search.Adapters.SearchPageAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
