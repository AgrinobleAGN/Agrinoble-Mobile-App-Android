...
public class SearchGroupAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Search.Adapters.SearchGroupAdapter, WoWonder", SearchGroupAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SearchGroupAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Search.Adapters.SearchGroupAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public SearchGroupAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == SearchGroupAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Search.Adapters.SearchGroupAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
