...
public class MusicBar_MyProgressAnimatorListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Library.MusicBar.MusicBar+MyProgressAnimatorListener, WoWonder", MusicBar_MyProgressAnimatorListener.class, __md_methods);
	}


	public MusicBar_MyProgressAnimatorListener ()
	{
		super ();
		if (getClass () == MusicBar_MyProgressAnimatorListener.class)
			mono.android.TypeManager.Activate ("WoWonder.Library.MusicBar.MusicBar+MyProgressAnimatorListener, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public MusicBar_MyProgressAnimatorListener (crc64c329e8b9820b9d61.MusicBar p0)
	{
		super ();
		if (getClass () == MusicBar_MyProgressAnimatorListener.class)
			mono.android.TypeManager.Activate ("WoWonder.Library.MusicBar.MusicBar+MyProgressAnimatorListener, WoWonder", "WoWonder.Library.MusicBar.MusicBar, WoWonder", this, new java.lang.Object[] { p0 });
	}
