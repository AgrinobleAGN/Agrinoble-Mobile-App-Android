...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Communities.Adapters.ReviewsAdapter, WoWonder", ReviewsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ReviewsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Communities.Adapters.ReviewsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ReviewsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ReviewsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Communities.Adapters.ReviewsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
