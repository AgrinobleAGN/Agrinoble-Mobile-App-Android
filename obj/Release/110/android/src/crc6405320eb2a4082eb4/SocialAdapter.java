...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Communities.Adapters.SocialAdapter, WoWonder", SocialAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SocialAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Communities.Adapters.SocialAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public SocialAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == SocialAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Communities.Adapters.SocialAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
