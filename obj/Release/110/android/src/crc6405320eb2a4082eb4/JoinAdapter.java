...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Communities.Adapters.JoinAdapter, WoWonder", JoinAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == JoinAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Communities.Adapters.JoinAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public JoinAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == JoinAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Communities.Adapters.JoinAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
