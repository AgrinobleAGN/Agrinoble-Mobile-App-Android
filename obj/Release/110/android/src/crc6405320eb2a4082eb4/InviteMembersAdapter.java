...
public class InviteMembersAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Communities.Adapters.InviteMembersAdapter, WoWonder", InviteMembersAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == InviteMembersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Communities.Adapters.InviteMembersAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public InviteMembersAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == InviteMembersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Communities.Adapters.InviteMembersAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
