...
public class SuggestedPageAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Suggested.Adapters.SuggestedPageAdapter, WoWonder", SuggestedPageAdapter.class, __md_methods);
	}


	public SuggestedPageAdapter ()
	{
		super ();
		if (getClass () == SuggestedPageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Suggested.Adapters.SuggestedPageAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public SuggestedPageAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == SuggestedPageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Suggested.Adapters.SuggestedPageAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
