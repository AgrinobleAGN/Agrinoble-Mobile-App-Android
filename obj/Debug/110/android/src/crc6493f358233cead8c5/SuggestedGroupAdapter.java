...
public class SuggestedGroupAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Suggested.Adapters.SuggestedGroupAdapter, WoWonder", SuggestedGroupAdapter.class, __md_methods);
	}


	public SuggestedGroupAdapter ()
	{
		super ();
		if (getClass () == SuggestedGroupAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Suggested.Adapters.SuggestedGroupAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public SuggestedGroupAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == SuggestedGroupAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Suggested.Adapters.SuggestedGroupAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
