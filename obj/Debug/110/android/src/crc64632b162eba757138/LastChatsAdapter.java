...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.MsgTabbes.Adapter.LastChatsAdapter, WoWonder", LastChatsAdapter.class, __md_methods);
	}


	public LastChatsAdapter ()
	{
		super ();
		if (getClass () == LastChatsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.MsgTabbes.Adapter.LastChatsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public LastChatsAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == LastChatsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.MsgTabbes.Adapter.LastChatsAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
