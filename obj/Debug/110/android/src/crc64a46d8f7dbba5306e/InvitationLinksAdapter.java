...
public class InvitationLinksAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.SettingsPreferences.Adapters.InvitationLinksAdapter, WoWonder", InvitationLinksAdapter.class, __md_methods);
	}


	public InvitationLinksAdapter ()
	{
		super ();
		if (getClass () == InvitationLinksAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.SettingsPreferences.Adapters.InvitationLinksAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public InvitationLinksAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == InvitationLinksAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.SettingsPreferences.Adapters.InvitationLinksAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
