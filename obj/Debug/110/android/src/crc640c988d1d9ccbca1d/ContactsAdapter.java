...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Contacts.Adapters.ContactsAdapter, WoWonder", ContactsAdapter.class, __md_methods);
	}
	...
	public ContactsAdapter ()
	{
		...
		if (getClass () == ContactsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Contacts.Adapters.ContactsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ContactsAdapter (android.app.Activity p0, boolean p1, int p2)
	{
		super ();
		if (getClass () == ContactsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Contacts.Adapters.ContactsAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.Boolean, mscorlib:WoWonder.Activities.Contacts.Adapters.ContactsAdapter+TypeTextSecondary, WoWonder", this, new java.lang.Object[] { p0, p1, p2 });
	}
