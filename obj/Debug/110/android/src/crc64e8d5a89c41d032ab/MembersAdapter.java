...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.GroupChat.Adapter.MembersAdapter, WoWonder", MembersAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MembersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.GroupChat.Adapter.MembersAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public MembersAdapter (android.app.Activity p0, boolean p1)
	{
		super ();
		if (getClass () == MembersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.GroupChat.Adapter.MembersAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.Boolean, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
