...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.AddPost.Adapters.ColorBoxAdapter, WoWonder", ColorBoxAdapter.class, __md_methods);
	}


	public ColorBoxAdapter ()
	{
		super ();
		if (getClass () == ColorBoxAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.AddPost.Adapters.ColorBoxAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ColorBoxAdapter (android.app.Activity p0, androidx.recyclerview.widget.RecyclerView p1)
	{
		super ();
		if (getClass () == ColorBoxAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.AddPost.Adapters.ColorBoxAdapter, WoWonder", "Android.App.Activity, Mono.Android:AndroidX.RecyclerView.Widget.RecyclerView, Xamarin.AndroidX.RecyclerView", this, new java.lang.Object[] { p0, p1 });
	}
