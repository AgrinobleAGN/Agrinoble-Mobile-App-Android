...
public class RecentDonationAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Fundings.Adapters.RecentDonationAdapter, WoWonder", RecentDonationAdapter.class, __md_methods);
	}


	public RecentDonationAdapter ()
	{
		super ();
		if (getClass () == RecentDonationAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Fundings.Adapters.RecentDonationAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public RecentDonationAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == RecentDonationAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Fundings.Adapters.RecentDonationAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
