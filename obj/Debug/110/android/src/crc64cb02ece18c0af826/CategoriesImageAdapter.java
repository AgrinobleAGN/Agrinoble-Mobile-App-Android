...
public class CategoriesImageAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Adapters.CategoriesImageAdapter, WoWonder", CategoriesImageAdapter.class, __md_methods);
	}


	public CategoriesImageAdapter ()
	{
		super ();
		if (getClass () == CategoriesImageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Adapters.CategoriesImageAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public CategoriesImageAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == CategoriesImageAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Adapters.CategoriesImageAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
