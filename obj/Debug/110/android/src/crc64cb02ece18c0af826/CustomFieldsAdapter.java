...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Adapters.CustomFieldsAdapter, WoWonder", CustomFieldsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == CustomFieldsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Adapters.CustomFieldsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public CustomFieldsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == CustomFieldsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Adapters.CustomFieldsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
