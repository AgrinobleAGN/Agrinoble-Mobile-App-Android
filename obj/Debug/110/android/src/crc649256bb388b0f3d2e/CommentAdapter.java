...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Comment.Adapters.CommentAdapter, WoWonder", CommentAdapter.class, __md_methods);
	}
	...
	public CommentAdapter ()
	{
		...
		if (getClass () == CommentAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Comment.Adapters.CommentAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public CommentAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == CommentAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Comment.Adapters.CommentAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
