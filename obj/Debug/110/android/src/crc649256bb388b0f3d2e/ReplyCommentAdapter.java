...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Comment.Adapters.ReplyCommentAdapter, WoWonder", ReplyCommentAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ReplyCommentAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Comment.Adapters.ReplyCommentAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ReplyCommentAdapter (crc646bb324bc4b123e90.ReplyCommentActivity p0)
	{
		super ();
		if (getClass () == ReplyCommentAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Comment.Adapters.ReplyCommentAdapter, WoWonder", "WoWonder.Activities.Comment.ReplyCommentActivity, WoWonder", this, new java.lang.Object[] { p0 });
	}
