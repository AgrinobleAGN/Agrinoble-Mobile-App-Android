...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Jobs.Adapters.JobNearbyAdapter, WoWonder", JobNearbyAdapter.class, __md_methods);
	}


	public JobNearbyAdapter ()
	{
		super ();
		if (getClass () == JobNearbyAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Jobs.Adapters.JobNearbyAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public JobNearbyAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == JobNearbyAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Jobs.Adapters.JobNearbyAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
