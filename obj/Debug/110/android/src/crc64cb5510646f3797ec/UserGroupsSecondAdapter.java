...
public class UserGroupsSecondAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.UserProfile.Adapters.UserGroupsSecondAdapter, WoWonder", UserGroupsSecondAdapter.class, __md_methods);
	}


	public UserGroupsSecondAdapter ()
	{
		super ();
		if (getClass () == UserGroupsSecondAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.UserGroupsSecondAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public UserGroupsSecondAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == UserGroupsSecondAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.UserGroupsSecondAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
