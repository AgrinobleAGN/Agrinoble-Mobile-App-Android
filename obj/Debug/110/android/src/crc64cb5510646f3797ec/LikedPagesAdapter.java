...
public class LikedPagesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.UserProfile.Adapters.LikedPagesAdapter, WoWonder", LikedPagesAdapter.class, __md_methods);
	}


	public LikedPagesAdapter ()
	{
		super ();
		if (getClass () == LikedPagesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.LikedPagesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public LikedPagesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LikedPagesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.UserProfile.Adapters.LikedPagesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
