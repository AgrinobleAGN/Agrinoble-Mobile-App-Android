...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Album.Adapters.PhotosAdapter, WoWonder", PhotosAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PhotosAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Album.Adapters.PhotosAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public PhotosAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == PhotosAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Album.Adapters.PhotosAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
