...
public class GamesViewActivity_MyWebViewClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Games.GamesViewActivity+MyWebViewClient, WoWonder", GamesViewActivity_MyWebViewClient.class, __md_methods);
	}


	public GamesViewActivity_MyWebViewClient ()
	{
		super ();
		if (getClass () == GamesViewActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.GamesViewActivity+MyWebViewClient, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public GamesViewActivity_MyWebViewClient (crc64135a19bce3cac32a.GamesViewActivity p0)
	{
		super ();
		if (getClass () == GamesViewActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.GamesViewActivity+MyWebViewClient, WoWonder", "WoWonder.Activities.Games.GamesViewActivity, WoWonder", this, new java.lang.Object[] { p0 });
	}
