...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Games.Adapters.MyGamesAdapter, WoWonder", MyGamesAdapter.class, __md_methods);
	}


	public MyGamesAdapter ()
	{
		super ();
		if (getClass () == MyGamesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.Adapters.MyGamesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public MyGamesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MyGamesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.Adapters.MyGamesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
