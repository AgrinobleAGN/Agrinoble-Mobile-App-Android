...
public class RecentGamesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Games.Adapters.RecentGamesAdapter, WoWonder", RecentGamesAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == RecentGamesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.Adapters.RecentGamesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public RecentGamesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == RecentGamesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.Adapters.RecentGamesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
