...
public class PopularGamesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Games.Adapters.PopularGamesAdapter, WoWonder", PopularGamesAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PopularGamesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.Adapters.PopularGamesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public PopularGamesAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == PopularGamesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Games.Adapters.PopularGamesAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
