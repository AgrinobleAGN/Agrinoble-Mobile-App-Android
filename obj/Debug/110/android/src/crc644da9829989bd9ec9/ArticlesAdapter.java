...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Articles.Adapters.ArticlesAdapter, WoWonder", ArticlesAdapter.class, __md_methods);
	}
	...
	public ArticlesAdapter ()
	{
		...
		if (getClass () == ArticlesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Articles.Adapters.ArticlesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ArticlesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ArticlesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Articles.Adapters.ArticlesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
