...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.Editor.Adapters.ColorPickerAdapter, WoWonder", ColorPickerAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ColorPickerAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.Editor.Adapters.ColorPickerAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ColorPickerAdapter (android.app.Activity p0, int p1, boolean p2)
	{
		super ();
		if (getClass () == ColorPickerAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.Editor.Adapters.ColorPickerAdapter, WoWonder", "Android.App.Activity, Mono.Android:WoWonder.Helpers.Model.Editor.ColorType, WoWonder:System.Boolean, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
