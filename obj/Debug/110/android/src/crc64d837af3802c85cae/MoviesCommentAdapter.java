...
public class MoviesCommentAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Movies.Adapters.MoviesCommentAdapter, WoWonder", MoviesCommentAdapter.class, __md_methods);
	}


	public MoviesCommentAdapter ()
	{
		super ();
		if (getClass () == MoviesCommentAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Movies.Adapters.MoviesCommentAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public MoviesCommentAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == MoviesCommentAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Movies.Adapters.MoviesCommentAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
