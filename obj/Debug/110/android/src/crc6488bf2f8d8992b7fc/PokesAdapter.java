...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Pokes.Adapters.PokesAdapter, WoWonder", PokesAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PokesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Pokes.Adapters.PokesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}
