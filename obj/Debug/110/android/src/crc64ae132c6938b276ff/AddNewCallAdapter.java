...
public class AddNewCallAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.Call.Adapters.AddNewCallAdapter, WoWonder", AddNewCallAdapter.class, __md_methods);
	}


	public AddNewCallAdapter ()
	{
		super ();
		if (getClass () == AddNewCallAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.Call.Adapters.AddNewCallAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public AddNewCallAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == AddNewCallAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.Call.Adapters.AddNewCallAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
