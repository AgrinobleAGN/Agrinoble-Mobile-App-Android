...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Tabbes.Adapters.ShortcutsAdapter, WoWonder", ShortcutsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ShortcutsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Tabbes.Adapters.ShortcutsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ShortcutsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ShortcutsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Tabbes.Adapters.ShortcutsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
