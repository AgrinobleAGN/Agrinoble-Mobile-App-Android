...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Tabbes.Adapters.ProPagesAdapter, WoWonder", ProPagesAdapter.class, __md_methods);
	}


	public ProPagesAdapter ()
	{
		super ();
		if (getClass () == ProPagesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Tabbes.Adapters.ProPagesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ProPagesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ProPagesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Tabbes.Adapters.ProPagesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
