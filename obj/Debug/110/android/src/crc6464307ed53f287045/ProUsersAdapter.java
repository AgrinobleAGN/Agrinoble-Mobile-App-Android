...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Tabbes.Adapters.ProUsersAdapter, WoWonder", ProUsersAdapter.class, __md_methods);
	}


	public ProUsersAdapter ()
	{
		super ();
		if (getClass () == ProUsersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Tabbes.Adapters.ProUsersAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public ProUsersAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ProUsersAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Tabbes.Adapters.ProUsersAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
