...
public class LastActivitiesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Tabbes.Adapters.LastActivitiesAdapter, WoWonder", LastActivitiesAdapter.class, __md_methods);
	}


	public LastActivitiesAdapter ()
	{
		super ();
		if (getClass () == LastActivitiesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Tabbes.Adapters.LastActivitiesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public LastActivitiesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LastActivitiesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Tabbes.Adapters.LastActivitiesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
