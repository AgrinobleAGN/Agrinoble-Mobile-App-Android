...
public class NativePostAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.NativePost.Post.NativePostAdapter, WoWonder", NativePostAdapter.class, __md_methods);
	}


	public NativePostAdapter ()
	{
		super ();
		if (getClass () == NativePostAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.NativePost.Post.NativePostAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public NativePostAdapter (android.app.Activity p0, java.lang.String p1, androidx.recyclerview.widget.RecyclerView p2, int p3)
	{
		super ();
		if (getClass () == NativePostAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.NativePost.Post.NativePostAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.String, mscorlib:AndroidX.RecyclerView.Widget.RecyclerView, Xamarin.AndroidX.RecyclerView:WoWonder.Activities.NativePost.Post.NativeFeedType, WoWonder", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
