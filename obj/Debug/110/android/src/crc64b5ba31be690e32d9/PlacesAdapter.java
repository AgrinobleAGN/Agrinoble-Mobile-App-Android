...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.PlacesAsync.Adapters.PlacesAdapter, WoWonder", PlacesAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PlacesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.PlacesAsync.Adapters.PlacesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public PlacesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == PlacesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.PlacesAsync.Adapters.PlacesAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
