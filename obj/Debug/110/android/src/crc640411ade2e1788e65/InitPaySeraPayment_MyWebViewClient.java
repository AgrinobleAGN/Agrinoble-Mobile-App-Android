...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Payment.InitPaySeraPayment+MyWebViewClient, WoWonder", InitPaySeraPayment_MyWebViewClient.class, __md_methods);
	}
	...
	public InitPaySeraPayment_MyWebViewClient ()
	{
		...
		if (getClass () == InitPaySeraPayment_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("WoWonder.Payment.InitPaySeraPayment+MyWebViewClient, WoWonder", "", this, new java.lang.Object[] {  });
	}
