...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.FriendRequest.Adapter.FriendRequestsAdapter, WoWonder", FriendRequestsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == FriendRequestsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.FriendRequest.Adapter.FriendRequestsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public FriendRequestsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == FriendRequestsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.FriendRequest.Adapter.FriendRequestsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
