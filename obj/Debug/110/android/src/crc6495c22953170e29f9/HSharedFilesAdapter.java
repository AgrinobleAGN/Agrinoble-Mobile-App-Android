...
public class HSharedFilesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.SharedFiles.Adapter.HSharedFilesAdapter, WoWonder", HSharedFilesAdapter.class, __md_methods);
	}


	public HSharedFilesAdapter ()
	{
		super ();
		if (getClass () == HSharedFilesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.SharedFiles.Adapter.HSharedFilesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public HSharedFilesAdapter (android.app.Activity p0, java.lang.String p1, java.lang.String p2)
	{
		super ();
		if (getClass () == HSharedFilesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.SharedFiles.Adapter.HSharedFilesAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.String, mscorlib:System.String, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
