...
public class SharedFilesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.SharedFiles.Adapter.SharedFilesAdapter, WoWonder", SharedFilesAdapter.class, __md_methods);
	}


	public SharedFilesAdapter ()
	{
		super ();
		if (getClass () == SharedFilesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.SharedFiles.Adapter.SharedFilesAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public SharedFilesAdapter (android.app.Activity p0, java.lang.String p1, java.lang.String p2)
	{
		super ();
		if (getClass () == SharedFilesAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.SharedFiles.Adapter.SharedFilesAdapter, WoWonder", "Android.App.Activity, Mono.Android:System.String, mscorlib:System.String, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
