...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Library.Anjo.EmojiView.StickersView.WoWonderStickers, WoWonder", WoWonderStickers.class, __md_methods);
	}
	...
	public WoWonderStickers ()
	{
		...
		if (getClass () == WoWonderStickers.class)
			mono.android.TypeManager.Activate ("WoWonder.Library.Anjo.EmojiView.StickersView.WoWonderStickers, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public WoWonderStickers (int p0)
	{
		super ();
		if (getClass () == WoWonderStickers.class)
			mono.android.TypeManager.Activate ("WoWonder.Library.Anjo.EmojiView.StickersView.WoWonderStickers, WoWonder", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
	}
