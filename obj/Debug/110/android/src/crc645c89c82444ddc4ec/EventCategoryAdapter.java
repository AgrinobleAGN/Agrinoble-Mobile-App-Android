...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Events.Adapters.EventCategoryAdapter, WoWonder", EventCategoryAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == EventCategoryAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Events.Adapters.EventCategoryAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public EventCategoryAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == EventCategoryAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Events.Adapters.EventCategoryAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
