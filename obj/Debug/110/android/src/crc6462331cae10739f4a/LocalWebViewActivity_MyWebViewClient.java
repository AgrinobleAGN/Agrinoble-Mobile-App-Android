...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.LocalWebViewActivity+MyWebViewClient, WoWonder", LocalWebViewActivity_MyWebViewClient.class, __md_methods);
	}
	...
	public LocalWebViewActivity_MyWebViewClient ()
	{
		...
		if (getClass () == LocalWebViewActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.LocalWebViewActivity+MyWebViewClient, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public LocalWebViewActivity_MyWebViewClient (crc6462331cae10739f4a.LocalWebViewActivity p0)
	{
		super ();
		if (getClass () == LocalWebViewActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.LocalWebViewActivity+MyWebViewClient, WoWonder", "WoWonder.Activities.LocalWebViewActivity, WoWonder", this, new java.lang.Object[] { p0 });
	}
