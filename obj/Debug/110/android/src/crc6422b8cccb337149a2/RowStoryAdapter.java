...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Story.Adapters.RowStoryAdapter, WoWonder", RowStoryAdapter.class, __md_methods);
	}


	public RowStoryAdapter ()
	{
		super ();
		if (getClass () == RowStoryAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Story.Adapters.RowStoryAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public RowStoryAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == RowStoryAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Story.Adapters.RowStoryAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
