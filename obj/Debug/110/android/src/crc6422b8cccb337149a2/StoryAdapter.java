...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Story.Adapters.StoryAdapter, WoWonder", StoryAdapter.class, __md_methods);
	}
	...
	public StoryAdapter ()
	{
		...
		if (getClass () == StoryAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Story.Adapters.StoryAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public StoryAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == StoryAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Story.Adapters.StoryAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
