...
public class StorySeenListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Story.Adapters.StorySeenListAdapter, WoWonder", StorySeenListAdapter.class, __md_methods);
	}


	public StorySeenListAdapter ()
	{
		super ();
		if (getClass () == StorySeenListAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Story.Adapters.StorySeenListAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public StorySeenListAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == StorySeenListAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Story.Adapters.StorySeenListAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
