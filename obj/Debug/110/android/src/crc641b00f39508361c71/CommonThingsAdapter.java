...
public class CommonThingsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.CommonThings.Adapters.CommonThingsAdapter, WoWonder", CommonThingsAdapter.class, __md_methods);
	}


	public CommonThingsAdapter ()
	{
		super ();
		if (getClass () == CommonThingsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.CommonThings.Adapters.CommonThingsAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public CommonThingsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == CommonThingsAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.CommonThings.Adapters.CommonThingsAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
