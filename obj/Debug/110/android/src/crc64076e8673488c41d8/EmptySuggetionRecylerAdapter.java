...
public class EmptySuggetionRecylerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Chat.ChatWindow.Adapters.EmptySuggetionRecylerAdapter, WoWonder", EmptySuggetionRecylerAdapter.class, __md_methods);
	}


	public EmptySuggetionRecylerAdapter ()
	{
		super ();
		if (getClass () == EmptySuggetionRecylerAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.ChatWindow.Adapters.EmptySuggetionRecylerAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public EmptySuggetionRecylerAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == EmptySuggetionRecylerAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Chat.ChatWindow.Adapters.EmptySuggetionRecylerAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
