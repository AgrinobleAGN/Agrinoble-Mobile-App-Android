...
public class MarketNearbyAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Market.Adapters.MarketNearbyAdapter, WoWonder", MarketNearbyAdapter.class, __md_methods);
	}


	public MarketNearbyAdapter ()
	{
		super ();
		if (getClass () == MarketNearbyAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Market.Adapters.MarketNearbyAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public MarketNearbyAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MarketNearbyAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Market.Adapters.MarketNearbyAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
