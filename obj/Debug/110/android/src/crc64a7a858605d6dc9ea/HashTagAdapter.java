...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WoWonder.Activities.Hashtag.Adapters.HashTagAdapter, WoWonder", HashTagAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == HashTagAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Hashtag.Adapters.HashTagAdapter, WoWonder", "", this, new java.lang.Object[] {  });
	}

	public HashTagAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == HashTagAdapter.class)
			mono.android.TypeManager.Activate ("WoWonder.Activities.Hashtag.Adapters.HashTagAdapter, WoWonder", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
